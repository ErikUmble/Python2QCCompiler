...
def oracle_from_graph(self, graph: Graph, clique_size: int) -> QuantumCircuit:
    # get edge list
    edges = graph.as_adjacency_matrix.flatten()
    num_nodes = graph.n
    ...
    return tweedledum.converters.to_qiskit(circ, "gatelist")
